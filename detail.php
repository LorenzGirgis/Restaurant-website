...
<body>
    ...
    <!-- details -->
    <div class="container-fluid mx-auto flex flex-col md:flex-row items-center bg-gray-100 ">
        <div class="flex flex-col w-full lg:w-1/2 justify-center items-center px-15 ">
            ...
            ?>
                <form action="winkel.php" method="post">
                    <p class="text-2xl font-light leading-normal mt-2 mb-8"><?= $naam ?> </p>
                    <p class="text-2xl font-light leading-normal mt-2 mb-8"><?php $desc ?> </p>
                    <p class="text-2xl font-light leading-normal mt-2 mb-8">&euro;<?= $price ?> </p>
                    <input type="hidden" name="pid" value="<?= $id ?>">
                    <input type="hidden" name="p_naam" value="<?= $naam ?>">
                    ...
                    <?php } else { ?>
                        <input type="number" name="p_qty" value="1" min="1" max="<?= $quantity?>" placeholder="Quantity" required>
                        <button class="text-l font-bold leading-tight bg-green-500 hover:text-white text-black font-bold py-3 px-12 " name="add_to_cart">In winkelmandje</button>
                    <?php
                    } 
                } else {
                    ?>
                        <p>je moet eerst inloggen voordat je besteld</p>
                    <?php
                    }
                    ?>
                </form>
        ...
        <div class="flex flex-col w-full lg:w-1/2 justify-center items-center px-15">
            <img class="w-full lg:w-4/5" src="src/images/<?= $image ?>">
