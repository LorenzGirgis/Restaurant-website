...
<body>
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar">
                ...
                <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white light:bg-gray-800 md:light:bg-gray-900 light:border-gray-700">
                    ...
                    <li>
                        <a href="contact.php" class="block py-2 pr-4 pl-3 text-white bg-red-700 rounded md:bg-transparent md:text-red-700 md:p-0 light:text-white" aria-current="page">Contact</a>
                    </li>
    ...
    <div class="icon2 container-fluid mx-auto flex flex-col md:flex-row items-center bg-gray-100">
        <div class="flex flex-col w-full lg:w-1/2 justify-center items-center px-15 ">
            <div class="text2 text-3xl font-light leading-normal mt-2 mb-8"></div>

            <div class="icon2 justify-center items-center">
                <P class="text-3xl">La Bella Vita <br> Koningin Wilhelminaplein 29, 1062 HJ Amsterdam<br> Tel: 020 669
                    0371<br> Openingstijden: Elke dag van 07:00 - 19:00<br>
            </div>
        </div>

        <div class="flex flex-col  justify-center items-center">
            <img class="lg:w-3/5 " src="src/images/contact.png">
        </div>
    </div>
