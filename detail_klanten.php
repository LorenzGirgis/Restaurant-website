...
<tr>
<th><div>voornaam</div></th>
<th><div>achernaam</div></th>
<th><div>geboortedatum</div></th>
<th><div>laatst gezien:</div></th>
</tr>
...
<?php $isAsc = isset($_GET['order']) ? (bool) $_GET['order'] : 1;
                try {
                    ...
                    foreach ($users as $users) {
                        echo "<tr><td>" . $users["firstname"] . "</td><td>" . $users["lastname"] . "</td><td>" . $users["geboortedatum"] . "</td><td>" . $users["last_seen"] . "</td><td>";
                    }
