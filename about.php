...
<body>
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar">
                ...
                <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white light:bg-gray-800 md:light:bg-gray-900 light:border-gray-700">
                    ...
                    <li>
                        <a href="about.php" class="block py-2 pr-4 pl-3 text-white bg-red-700 rounded md:bg-transparent md:text-red-700 md:p-0 light:text-white" aria-current="page">About</a>
                    </li>
    ...
    <div class="squares ">
        <div class="icon1">
            <main> <img src="src/images/food.png"> </main>
        </div>
        <div class="icon2">
            <P class="text-2xl">'La Bella Vita' betekent 'het<br> goede leven'. En dat is exact<br> wat je bij ons
                proeft!
                Roberto<br> Casto laat je genieten van<br> de smaken uit Puglia - de<br> prachtige streek in het<br>
                zuiden van
                Italië met Bari als<br> hoofdstad. Ervaar de lokale<br> specialiteiten en waan je<br> even in 'Bella
                Italia'!
            </P>
